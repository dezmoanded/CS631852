...
<html>
    ...
    <body>
        <h1>Hello World! See You Latery</h1>
    </body>
    <BODY>
...
switch( key.intValue() )
{
   case ID_PHYSICIAN :
           ...
           response.sendRedirect("add_remove_staff_member_db_r_1_1.jsp");
        break;
   case ID_NURSE :
           out.println("It\'s Nurse.");
           response.sendRedirect("add_remove_staff_member_db_r_2_1.jsp");
        break;
   case ID_STAFF :
           out.println("It\'s Staff.");
           response.sendRedirect("add_remove_staff_member_db_r_3_1.jsp");
        break;
   case ID_SURGEON :
           out.println("It\'s Surgeon.");
           response.sendRedirect("add_remove_staff_member_db_r_4_1.jsp");
        break;     
}
}
