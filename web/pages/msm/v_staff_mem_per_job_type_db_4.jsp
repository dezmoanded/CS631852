<%-- 
    Document   : v_staff_mem_per_job_type_db_4
    Created on : Apr 27, 2017, 12:12:34 AM
    Author     : bakfark
--%>
...
<sql:query var="surgeons1" dataSource="jdbc/HospitalDatabase">
    ...
    AND Surgeons.ID = Physicians.ID
</sql:query>
    
<table  align="left" border="1">
    <!-- column headers -->
    <tr>
    <c:forEach var="columnName" items="${surgeons1.columnNames}">
        <th><c:out value="${columnName}"/></th>
    </c:forEach>
    
    </tr>
<!-- column data -->
<c:forEach var="row" items="${surgeons1.rowsByIndex}">
    <tr>
